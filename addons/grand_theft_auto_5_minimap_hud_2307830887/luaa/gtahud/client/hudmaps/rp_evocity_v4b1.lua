local HUDMAP = {}
HUDMAP.Map = "rp_evocity_v4b1"
HUDMAP.Material = "paris/maps/rp_evocity_v4b1/rp_evocity_v4b1"
...
HUDMAP.Zones = {}
HUDMAP.Zones["MAIN"] = {
    Material = "paris/maps/rp_evocity_v4b1/rp_evocity_v4b1",
    Translate = Vector(-463.164,328.5042,0), // Never do Z
    ScaleX = 1.1303,
    ScaleY = 1.0170,
    Zoom = 0.9,
}
...
HUDMAP.Zones["POLICE"] = {
    Material = "paris/maps/rp_evocity_v4b1/rp_evocity_v4b1_police",
    Translate = Vector(-463.164,328.5042,0), // Never do Z
    ScaleX = 1.1303,
    ScaleY = 1.0170,
    InsideZones = {
