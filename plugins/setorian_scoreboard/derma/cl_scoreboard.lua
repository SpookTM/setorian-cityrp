...
function PANEL:Update()
	...
	if (character and character:GetHeadmodel() and string.find(character:GetHeadmodel(), "models") and character:GetHeadmodel() != NULL and character:GetHeadmodel() != "" and character:GetHeadmodel() != nil) then
		model = character:GetHeadmodel()
	end
