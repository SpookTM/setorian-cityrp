...
ITEM.name = "LSD 25 Sheets"
ITEM.model = Model("models/psychedelics/lsd/blotter/25sheet.mdl")
...
ITEM.functions.Crop = {
    ...
    OnRun = function(item)
        ...
        for i=1, 4 do
            if (!inventory:Add("psychedelics_blotter_5sheet")) then
                ix.item.Spawn("psychedelics_blotter_5sheet", client)
            end
        end
