...
FACTION.description = "Are responsible for maintaining the server, enforcing the rules, assisting players, and ensuring a positive gaming experience for all users."
